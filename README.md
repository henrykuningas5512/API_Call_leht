...
Veendu, et su arvutis on olemas Node.js ja npm.

Alustamiseks klooni repo:

```bash
git clone https://github.com/henrykuningas5512/API_Call_leht.git
cd API_Call_leht
```

Seejärel projekti juurkaustas:
...
Peale käivitamist on rakendus kättesaadav aadressil:
